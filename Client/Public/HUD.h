...
class CHUD final : public CGameObject
{
public:
...
private:
	CHUD(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CHUD(const CHUD& _rhs);
...
public:
	static CHUD* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
