...
class CFlyingOctorok final : public CMonster
{
private:
	CFlyingOctorok(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CFlyingOctorok(const CFlyingOctorok& _rhs);
	virtual ~CFlyingOctorok() = default;
...
public:
	static CFlyingOctorok* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
