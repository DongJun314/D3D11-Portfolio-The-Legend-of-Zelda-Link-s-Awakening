...
class CPiccolo final : public CMonster
{
private:
	CPiccolo(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CPiccolo(const CPiccolo& _rhs);
	virtual ~CPiccolo() = default;
...
public:
	static CPiccolo* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
