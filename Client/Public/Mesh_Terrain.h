...
class CMesh_Terrain final : public CGameObject
{

private:
	CMesh_Terrain(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CMesh_Terrain(const CMesh_Terrain& _rhs);
...
public:
	static CMesh_Terrain* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
