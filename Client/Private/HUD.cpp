...
CHUD::CHUD(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext)
	: CGameObject(_pDevice, _pContext)
{
}

CHUD::CHUD(const CHUD& _rhs)
	: CGameObject(_rhs)
{
}
...
HRESULT CHUD::Initialize(void* _pArg, _uint _iLevel)
{
	if (nullptr == _pArg)
	{
...
void CHUD::Priority_Tick(_float _fTimeDelta)
{
	int a = 10;
}

void CHUD::Tick(_float _fTimeDelta)
{
	int a = 10;
}
...
HRESULT CHUD::Add_Component(_uint _iLevel)
{
	switch (_iLevel)
	{
	case LEVEL_LOADING:
...
CHUD* CHUD::Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext)
{
	CHUD* pInstance = new CHUD(_pDevice, _pContext);
...
CGameObject* CHUD::Clone(void* _pArg, _uint _iLevel)
{
