...
CVIBuffer_Particle_Rect::CVIBuffer_Particle_Rect(const CVIBuffer_Particle_Rect& _rhs)
    : CVIBuffer_Instancing(_rhs)
{
}

HRESULT CVIBuffer_Particle_Rect::Initialize_Prototype(_uint _iNumInstance)
{
...
CVIBuffer_Particle_Rect* CVIBuffer_Particle_Rect::Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext, _uint _iNumInstance)
{
